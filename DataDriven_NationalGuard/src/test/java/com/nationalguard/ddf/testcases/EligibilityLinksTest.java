...
public class EligibilityLinksTest extends BaseTest {
	
	String testName = "EligibilityLinksTest";
	Xls_Reader xls;
	...
	public void fitnessCalculator(Hashtable<String, String> data) throws IOException {
		...
		test.log(Status.INFO, "Eligibility Links Test Started");
		 ...
		 * Link Test
		 ***************************************/
		getWebPageText("practiceasvab_xpath","asvablinktext_xpath");
		getWebPageText("weightcalculatorlink_xpath", "weightcalculatorlinktext_xpath");
